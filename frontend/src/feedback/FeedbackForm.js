...
const FeedbackForm = (props) => {
  ...
  const host = "http://localhost:3010/feedback";
    ...
    <>
      ...
      <div className="addnotes " style={{ paddingTop: "50px", margin: "auto" }}>
        <div className=" right ps-5 pe-5 pt-4 mb-5" style={{ backgroundColor: `${props.theme === 'dark' ? '#333' : ''}`, color: `${props.theme === 'dark' ? '#f5f5f5' : '#333'}` }}>
          ...
          <p className="mb-4 text-center">Thank you for taking your time to provide feedback. I appreciate hearing from you and will review your comments carefully.</p>
          ...
          <form className={`feedback-form ${props.theme === 'dark' ? 'dark-mode' : ''}`} onSubmit={handleSubmit}>
            ...
            <h6 className="container mt-4" style={{ marginBottom: "-1px", textAlign: "center" }}>How would you rate this website?</h6>
            <div className='container-star '>
              <div className="star-widget" style = {{ marginLeft: "60px" }}>
