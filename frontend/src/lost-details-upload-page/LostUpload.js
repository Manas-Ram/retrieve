...
const LostUpload = (props) => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      await axios.post('http://localhost/lost/submitLostItem', formData, {
        headers: {
      ...
      case 'Cards':
        return (
          <select
            style={{
              backgroundColor: `${
                props.theme === 'dark' ? 'rgb(74 72 72)' : ''
              }`,
              color: `${props.theme === 'dark' ? '#f5f5f5' : ''}`,
            }}
            id='subcategory'
            value={subcategory}
            className='pb-1 pt-2'
  ...
  return (
    <>
      <h1 style={{ color: `${props.theme === 'dark' ? '#f5f5f5' : '#333'}` }}>
        Lost Item details
      </h1>

      <form
        style={{
          backgroundColor: `${props.theme === 'dark' ? 'rgb(74 72 72)' : ''}`,
          marginBottom: '150px',
        }}
      ...
      >
        <div className='col-5'>
          <label
            style={{ color: `${props.theme === 'dark' ? '#f5f5f5' : ''}` }}
            htmlFor='description'
          >
            Description
            <input
